...
if ( ! function_exists( 'cs_flash_message_add' ) ) {
	/**
...
if ( ! function_exists( 'cs_flash_messages_show' ) ) {
	 ...
	 * @return void
	 */
	function cs_flash_messages_show( $echo = true ) {
		$flashMessages = \CSPromo\Core\Admin\Actions\FlashMessages::getInstance();
