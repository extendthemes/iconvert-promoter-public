...
class EmailListContactsPage {
	...
	public function index() {
		...
		if ( $search_email ) {
			$totalRecords = $service->getRecordsByListSearch( $listID, $perPage, Pagination::getPageNumber(), esc_sql( $search_email ) );
		} else {
			$totalRecords = $service->getRecordsByList( $listID, $perPage, Pagination::getPageNumber() );
		}
