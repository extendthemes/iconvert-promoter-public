				...
				<div class="row">
						...
						<div class="ic-upgrade-why-card">
							...
							<div class="ic-upgrade-why-card-list">
								<ul>
									...
									$why_items = array(
										array(
											'title' => esc_html__( '100+ Premium Templates', 'iconvert-promoter' ),
											'desc'  => esc_html__( 'Access high-converting designs for any campaign.', 'iconvert-promoter' ),
										),
										array(
											'title' => esc_html__( 'Multiple Pop-Up Types', 'iconvert-promoter' ),
											'desc'  => esc_html__( 'Create lightbox, slide-in, floating bars, inline promotions & more.', 'iconvert-promoter' ),
										),
										array(
											'title' => esc_html__( 'Advanced Targeting', 'iconvert-promoter' ),
											'desc'  => esc_html__( 'Show pop-ups based on visitor behavior, cart content, traffic source & location.', 'iconvert-promoter' ),
										),
										array(
											'title' => esc_html__( 'Email List Building', 'iconvert-promoter' ),
											'desc'  => esc_html__( 'Collect leads directly in WordPress & integrate with top email services.', 'iconvert-promoter' ),
										),
										array(
											'title' => esc_html__( 'Drag & Drop Editor', 'iconvert-promoter' ),
											'desc'  => esc_html__( 'Easily customize pop-ups for any device with full control over design & animations.', 'iconvert-promoter' ),
										),
									);
					...
					<div class="col ic-promo-upgrade-steps">
						...
						<div class="ic-upgrade-steps-action">
							<a href="<?php echo esc_url( $upgrade_url ); ?>" class="ic-promo-button ic-promo-button-primary">
								<?php esc_html_e( 'Upgrade to iConvert Promoter PRO', 'iconvert-promoter' ); ?>
							</a>
						</div>
					</div>
