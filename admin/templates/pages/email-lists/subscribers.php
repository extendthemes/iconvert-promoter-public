	...
	<div class="container-records list-records">
		<?php if ( $records || $isSearchResultsPage ) : ?>
			<div class="cs-email-lists-search-subscribers">
				<form action="<?php echo esc_url( cs_generate_page_url( 'subscribers.lists.emails', array( 'post_id' => $listID ), IC_PROMO_PAGE_SUBSCRIBERS ) ); ?>">
					<input type="hidden" name="page" value="<?php echo esc_attr( IC_PROMO_PAGE_SUBSCRIBERS ); ?>" />
					...
					<tbody>
						<?php foreach ( $records as $record ) : ?>
							<tr>
								...
								<td>
									<a class="cs-el-edit js-disable-middle-click" href="#" data-id="<?php echo esc_attr( $record->id ); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_attr_e( 'Edit', 'iconvert-promoter' ); ?>">
										<i class="dashicons-before dashicons-edit js-disable-middle-click"></i>
									</a>
								</td>
								<td class="cs-el-remove">
									<a class="cs-el-delete js-disable-middle-click" href="#" data-id="<?php echo esc_attr( $record->id ); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_attr_e( 'Remove from list', 'iconvert-promoter' ); ?>">
