<div class="ic-promo-wrapper d-flex flex-column">
	<div class="header d-flex justify-content-between align-items-center">
		...
		<div class="box-cta">
			<?php if ( cs_is_current_page( 'promos.list' ) ) : ?>
				<a class="ic-promo-button ic-promo-button-primary button-create-campaign" href="<?php echo esc_url( cs_generate_page_url( 'promo.create' ) ); ?>"><?php esc_html_e( 'New Campaign', 'iconvert-promoter' ); ?></a>
			<?php endif; ?>

			<?php if ( cs_is_current_page( 'promo.create' ) ) : ?>
				...
				<?php wp_nonce_field( 'cs_create_popup' ); ?>
			<?php endif; ?>

			<?php if ( cs_is_current_page( 'promo.edit' ) ) : ?>
				<div class="submit-button">
					...
					<?php wp_nonce_field( 'icp_update-popup' ); ?>
				</div>
			<?php endif; ?>
		</div>
	</div>
	<div class="body
	<?php
	if ( cs_is_current_page( 'promos.list' ) && isset( $popups ) && ! $popups ) :
		?>
