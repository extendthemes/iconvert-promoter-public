	...
	return (
		<NavigationButton path={parentMenu + '/colors/background'}>
			<HStack justify="flex-start">
				...
				<FlexItem>{__('Background', 'kubio')}</FlexItem>
			</HStack>
		</NavigationButton>
	);
}
	...
	return (
		<NavigationButton path={parentMenu + '/colors/text'}>
			<HStack justify="flex-start">
				...
				<FlexItem>{__('Text', 'kubio')}</FlexItem>
			</HStack>
		</NavigationButton>
	);
}
	...
	return (
		<NavigationButton path={parentMenu + '/colors/link'}>
			<HStack justify="flex-start">
				...
				<FlexItem>{__('Links', 'kubio')}</FlexItem>
			</HStack>
		</NavigationButton>
	);
}
		...
		<>
			...
			<div className="edit-site-global-styles-screen-colors">
				<VStack spacing={10}>
					...
					<VStack spacing={3}>
						<Subtitle>{__('Elements', 'kubio')}</Subtitle>
