...
export const CUSTOM_TEMPLATES = 'kubio__custom-templates';
export const THEME_TEMPLATES = 'kubio__theme-templates';
export const KUBIO_TEMPLATES = 'kubio__kubio-templates';
