...
export const TOOLSPANEL_DROPDOWNMENU_PROPS = {
	popoverProps: {
		...
		offset: 25, // Inner sidebar width (248px) - button width (24px) - border (1px) + padding (16px) + spacing (20px)
	},
};

export const TOOLSPANEL_DROPDOWNMENU_PROPS_V1 = {
	popoverProps: {
		placement: 'right-start',
		offset: 300, // Inner sidebar width (248px) - button width (24px) - border (1px) + padding (16px) + spacing (20px)
	},
};
