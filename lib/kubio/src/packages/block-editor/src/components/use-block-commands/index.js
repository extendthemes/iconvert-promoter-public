...
export const useTransformCommands = () => {
	...
	const commands = possibleBlockTransformations.map( ( transformation ) => {
		...
		return {
			...
			label: sprintf( __( 'Transform to %s', 'kubio' ), title ),
