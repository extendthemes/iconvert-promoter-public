			...
			[
				{
					...
					title: _x( 'Resolve', 'imperative verb', 'kubio' ),
					onClick: () => setCompare( true ),
				},
				canInsertHTMLBlock && {
					title: __( 'Convert to HTML', 'kubio' ),
					onClick: convert.toHTML,
				},
				canInsertClassicBlock && {
					title: __( 'Convert to Classic Block', 'kubio' ),
			...
			<Warning
				actions={ [
					<Button
						...
						variant="primary"
					>
						{ __( 'Attempt Block Recovery', 'kubio' ) }
					</Button>,
				] }
			...
			{ compare && (
				...
				>
					<BlockCompare
						...
						convertButtonText={ __( 'Convert to Blocks', 'kubio' ) }
					/>
				</Modal>
			) }
		</>
