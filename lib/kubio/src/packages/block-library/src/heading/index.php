...
class HeadingBlock extends BlockBase {
	...
	public function getScriptAttributeName() {
		$block_prefix          = Utils::getKubioBlockPrefix();
		$script_name_attribute = "data-$block_prefix-component";
		return $script_name_attribute;
	}
	...
	public function getRotatingHeading( $fancy ) {
		...
		$script_name_attribute = $this->getScriptAttributeName();
		ob_start();

		// phpcs:disable
		?>
		<span <?php echo $script_name_attribute; ?>="fancy-title"
