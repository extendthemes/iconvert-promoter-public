...
const styleTypeOptions = [
	{ value: 'official', label: __('Official', 'kubio') },
	{ value: 'shared', label: __('Shared', 'kubio') },
	{ value: 'individual', label: __('Individual', 'kubio') },
];

const toggleStatesValues = {
	NORMAL: 'normal',
	HOVER: 'hover',
};

const stateToggle = {
	values: toggleStatesValues,
	options: [
		{ label: __('Normal', 'kubio'), value: toggleStatesValues.NORMAL },
		{ label: __('Hover', 'kubio'), value: toggleStatesValues.HOVER },
	],
};
