...
export const COLOR_POPOVER_PROPS = {
	className:
		'components-custom-gradient-picker__color-picker-popover kubio-popup',
	position: 'top center',
};
...
export const GRADIENT_OPTIONS = [
	{ value: 'linear-gradient', label: __( 'Linear', 'kubio' ) },
	{ value: 'radial-gradient', label: __( 'Radial', 'kubio' ) },
];
