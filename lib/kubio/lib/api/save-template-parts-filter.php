...
add_filter( Utils::getStringWithNamespacePrefix( 'kubio/save-template-entity/page/autosave' ), __NAMESPACE__ . '\\kubio_template_autosave', 10, 2 );
add_filter( Utils::getStringWithNamespacePrefix( 'kubio/save-template-entity/wp_template/autosave' ), __NAMESPACE__ . '\\kubio_template_autosave', 10, 2 );
add_filter( Utils::getStringWithNamespacePrefix( 'kubio/save-template-entity/wp_template_part/autosave' ), __NAMESPACE__ . '\\kubio_template_autosave', 10, 2 );
