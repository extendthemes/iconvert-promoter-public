...
use KPromo\Core\StyleManager\BlockStyleRender;
...
class BlockBase extends DataHelper {
	...
	public function __construct( $block, $autoload = true, $context = array() ) {
		...
		$this->local_id = Utils::uniqueId( 'promo-' );
	}
	...
	public function mapPropsToElementsWithDefaults() {
		...
		/**
		 * Set anchor. KPromo sets anchor without the source and attribute parameters in the gutenberg attribute. If you
