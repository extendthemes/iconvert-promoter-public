...
use KPromo\Config;
use KPromo\Core\Blocks\DataHelper;
...
class GlobalStyleRender extends StyleRender {
	...
	public function __construct( $main_attr, $prefixSelectorsByType = null ) {
		...
		if ( $prefixSelectorsByType ) {
			$parentOptions['prefixSelectorsByType'] = $prefixSelectorsByType;
		}
		parent::__construct(
			$parentOptions
		);
