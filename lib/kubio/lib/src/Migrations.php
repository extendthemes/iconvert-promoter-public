...
/**
 *
 *  KPromo migration purpose is to apply certain changes to existing sites besides new ones.
...
class Migrations {
	...
	private static function getMigrations() {
		...
		return apply_filters( CoreUtils::getStringWithNamespacePrefix( 'kubio/available_migrations' ), $migrations );
	}
