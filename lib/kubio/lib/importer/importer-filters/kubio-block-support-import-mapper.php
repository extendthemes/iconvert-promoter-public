...
function kubio_apply_block_support_import_mapper( $block, $block_name ) {
	...
	if ( Utils::isKubioBlock( $block ) && isset( $block_type->supports['kubio'] ) ) {
...
add_filter( Utils::getStringWithNamespacePrefix( 'kubio/importer/maybe_import_block_assets' ), __NAMESPACE__ . '\\kubio_apply_block_support_import_mapper', 10, 2 );
